...
// ── 弹窗状态 ──
const showPicker = ref(false)     // 是否显示头像选择弹窗
...
// 兜底：index.json 缺失时显示的默认清单（按实际文件名修改）
    ...
    <div class="info-page">
      ...
      <div class="info-body" v-if="info">
        ...
        <div class="form-card">
          <div class="form-row">
            <label>名字</label>
            <input v-model="info.name" placeholder="填写你的名字" />
          </div>
          <div class="form-row">
            <label>ID</label>
            <input v-model="info.id" placeholder="填写 ID" />
          </div>
          <div class="form-row">
            <label>性别</label>
